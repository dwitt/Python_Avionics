...
*/
/**************************************************************************/
uint16_t Sensor_Calibration::crc16_update(uint16_t crc, uint8_t a) {
  int i;
  crc ^= a;
  for (i = 0; i < 8; i++) {
    if (crc & 1) {
...
*/
/**************************************************************************/
bool Sensor_Calibration::calibrate(sensors_event_t &event) {
...
*/
/**************************************************************************/
bool Sensor_Calibration::hasEEPROM(void) {
  return true;
}
...
*/
/**************************************************************************/
bool Sensor_Calibration::hasFLASH(void) {
  return false;
}
